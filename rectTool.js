function rectangleTool(){
	...
	var startMouseX = -1;	//Initialize startMouseX to -1 to indicate that a rectangle is not currently being drawn
	var startMouseY = -1;	//Initialize startMouseY to -1 to indicate that a rectangle is not currently being drawn
	var drawing = false;
	...
	this.draw = function(){
		...
		if(mouseIsPressed){
			...
			if(startMouseX == -1){  //Trigger if line was not already being drawn
				...
				rect(startMouseX, startMouseY, mouseX-startMouseX, mouseY-startMouseY); //Draw rect from start point to current mouse point
			}
